...
export const fetchAll:any=commonCreateAsyncThunk({type:'goldtype/fetchAll',action:GoldtypeService.fetchAll})
export const addItem:any=commonCreateAsyncThunk({type:'goldtype/addItem',action:GoldtypeService.addItem})
export const editItem:any=commonCreateAsyncThunk({type:'goldtype/editItem',action:GoldtypeService.editItem})
export const deleteItem:any=commonCreateAsyncThunk({type:'goldtype/deleteItem',action:GoldtypeService.deleteItem})
export const restoreItem:any=commonCreateAsyncThunk({type:'goldtype/restoreItem',action:GoldtypeService.restoreItem})
export const goldtypeSlice = createSlice({
    name: 'goldtype',
    initialState,
    reducers: {
        selectItem:(state, action)=>{
            state.filteredList=GoldtypeService.activeIfSelectAndDeactiveOthers(action.payload.id,state.filteredList);
    ...
    extraReducers: (builder) => {
        ...
        .addCase(fetchAll.fulfilled, (state, action) => {
            const list=GoldtypeService.listFromJson(action.payload.data!==''?action.payload.data.goldTypes:[])
            state.list=list
