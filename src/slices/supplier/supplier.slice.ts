...
export const fetchAll: any = commonCreateAsyncThunk({
  type: "supplier/fetchAll",
  action: SupplierService.fetchAll,
});
export const addItem: any = commonCreateAsyncThunk({
  type: "supplier/addItem",
  action: SupplierService.addItem,
});
export const editItem: any = commonCreateAsyncThunk({
  type: "supplier/editItem",
  action: SupplierService.editItem,
});
export const deleteItem: any = commonCreateAsyncThunk({
  type: "supplier/deleteItem",
  action: SupplierService.deleteItem,
});
export const restoreItem: any = commonCreateAsyncThunk({
  type: "supplier/restoreItem",
  action: SupplierService.restoreItem,
});
...
export const supplierSlice = createSlice({
  ...
  reducers: {
    selectItem: (state, action) => {
      state.filteredList = SupplierService.activeIfSelectAndDeactiveOthers(
        action.payload,
        state.filteredList
      );
