...
import { actions, partner, status } from "../../types";
...
import { ContentLoading, DynamicDialog, EmptyBox, EmptyHeight, StatusDropdown, PartnerDropdown } from "../../components/commons";
...
export default function AllSupplier() {
    ...
    const handleCustomerChange = () => {
        formik.setFieldValue("customer", true);
        formik.setFieldValue("supplier", false);
    };

    const handleSupplierChange = () => {
        formik.setFieldValue("customer", false);
        formik.setFieldValue("supplier", true);
    };
    const filterList = () => {
            ...
            <DynamicDialog visible={isShowDialog} position={undefined}
                ...
                body={
                    <div className="p-2">
                        ...
                        <div className="row mb-2">
                            <label className="radio-inline col-md-6">
                                <RadioButton
                                    disabled={disableInput}
                                    type="radio"
                                    name="customer"
                            ...
                            <label className="radio-inline col-md-6">
                                <RadioButton
                                    ...
                                    onChange={handleSupplierChange} /> Nhà cung cấp
                            </label>
                        </div>
                    </div>
                }
                    ...
                    supplierState.status === 'loading' ?
                        ...
                        <>
                            ...
                            <OverlayPanel ref={op} style={{ width: "300px" }}>
                                ...
                                <div className="row pb-2">
                                    <div className="form-group col-sm-12">
                                        <label htmlFor="from-date">Đối tác:</label>
                                        <PartnerDropdown
                                            value={partner} onChange={(e: DropdownChangeEvent) => {
                                                setPartner(e.value)
                                            }
                                            } />
